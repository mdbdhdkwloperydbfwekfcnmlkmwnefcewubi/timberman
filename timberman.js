...
// Game Over
var savebutton      = loadSprite("assets/image/savebutton.png", onReady, saveSession);
...
function saveSession() {
	x = sessionID;
	d = score;
	msg = "Numer sesji to: " + x + "\r\n" + "Zdobyte punkty: " + d + "\r\n" + "ID sesji zosta³o automatycznie skopiowane do schowka!";
	alert(msg);
}
...
function gameOver() {
	...
	sessionID = getRandomIntInclusive(100,999);
	randomCharacter1 = alphabet[Math.floor(Math.random() * alphabet.length)];
	randomCharacter2 = alphabet[Math.floor(Math.random() * alphabet.length)];
	randomCharacter3 = alphabet[Math.floor(Math.random() * alphabet.length)];
	
	sessionID = sessionID + "-" + randomCharacter1 + randomCharacter2 + randomCharacter3;
	sessionID1 = getRandomIntInclusive(100,999);
	randomCharacter1 = alphabet[Math.floor(Math.random() * alphabet.length)];
	randomCharacter2 = alphabet[Math.floor(Math.random() * alphabet.length)];
	randomCharacter3 = alphabet[Math.floor(Math.random() * alphabet.length)];
	sessionID = sessionID + "-" + sessionID1 + "-" + randomCharacter1 + randomCharacter2 + randomCharacter3;
...
function renderGame() {
	...
	if (level == levelGameOver) {
		...
		displaySprite(play, 120, 900);
		displaySprite(savebutton, 600, 900);
